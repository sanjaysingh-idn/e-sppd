...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('template') }}/assets/" data-template="vertical-menu-template-free">

    <head>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

        <title>Login Page | SIPERJADIN</title>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('template/assets/img/favicon') }}/android-icon-192x192.png">
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('template/assets/img/favicon') }}/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('template/assets/img/favicon') }}/favicon-96x96.png">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <div class="logo">
                                    <img src="{{ asset('template/assets/img/favicon') }}/logo.png" class="w-100" alt="Logo Kemendagri">
