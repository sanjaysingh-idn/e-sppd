        ...
        <div class="card-body">
            <div class="row">
                <div class="mb-3 col-md-5">
                    ...
                    <input class="form-control @error('kode_spd') is-invalid @enderror" type="text" id="kode_spd" name="kode_spd" value="{{ old('kode_spd') }}" autofocus />
                    @error('kode_spd')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <input type="radio" class="btn-check" name="jenis_perjalanan" value="{{ $jp }}" id="{{ $jp }}" autocomplete="off">
                ...
                <div class="mb-3 col-md-3">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <input type="radio" class="btn-check" name="jenis_transportasi" value="{{ $jt }}" id="{{ $jt }}" autocomplete="off">
                ...
                <div class="mb-3 col-md-12">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="provinsi" class="form-select @error('provinsi') is-invalid @enderror" name="provinsi" required style="width: 100%">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select id="kota" class="form-select @error('kota') is-invalid @enderror" name="kota" required style="width: 100%">
                ...
                <div class="mb-3 col-12">
                    ...
                    <textarea class="form-control @error('maksud') is-invalid @enderror" type="text" id="maksud" name="maksud" />{{ old('maksud') }}</textarea>
                    @error('maksud')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3 col-12">
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <input class="form-control @error('tanggal_mulai') is-invalid @enderror" type="date" id="tanggal_mulai" name="tanggal_mulai" min="{{ date('Y-m-d') }}" value="{{ old('tanggal_mulai') }}" />
                                    @error('tanggal_mulai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <input class="form-control @error('tanggal_pulang') is-invalid @enderror" type="date" id="tanggal_pulang" name="tanggal_pulang" min="{{ date('Y-m-d') }}" value="{{ old('tanggal_pulang') }}" />
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('lama') is-invalid @enderror" placeholder="2" aria-label="1" name="lama" value="{{ old('lama') }}">
                                ...
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('malam') is-invalid @enderror" placeholder="1" aria-label="1" name="malam" value="{{ old('malam') }}">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select id="users" class="form-select @error('users') is-invalid @enderror" name="users[]" multiple style="width: 100%">
                                @foreach ($user as $item)
                                @if (!$item->spd_id)
                                <option value="{{ $item->id }}" class="text-capitalize">
                                    {{ $item->name }} | <strong>{{ $item->nip }}</strong> | {{ $item->golongan->golongan_name }}
                                </option>
                                @endif
                                @endforeach
                            </select>
            ...
            <div class="mt-2">
                <button type="submit" class="btn btn-primary me-2" @if(!Auth::user()->spd_id) {{ "" }} @else disabled @endif><i class="bx bx-send"></i> Kirim</button>
